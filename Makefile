...
train: # data
	rm -rf random_search
	$(PYTHON_INTERPRETER) src/models/train_model.py --input_filepath=data/processed --output_filepath=models/ --pad_sequences_maxlen=1000 --max_words=30000 --epochs=2 --batch_size=128 --output_dim=50
