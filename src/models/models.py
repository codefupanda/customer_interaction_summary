...
from tensorflow.keras.layers import Embedding, Flatten, Dense, Softmax, LSTM, SimpleRNN, Conv1D, MaxPooling1D, GlobalMaxPooling1D

class DNNModel(Model):

    def __init__(self, pad_sequences_maxlen, max_words, number_of_classes, embedding_matrix=None):
